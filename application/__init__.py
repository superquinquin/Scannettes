...
def create_app(config_name: str = None, main: bool = True) -> Flask :
  ...
  app.add_url_rule('/lobby/<id>&type=purchase&roomtoken=<room_token>', view_func= routes.get_purchase_room)
  app.add_url_rule('/lobby/<id>&type=inventory&roomtoken=<room_token>', view_func= routes.get_inventory_room)
  app.add_url_rule('/lobby/admin/<id>&type=purchase&roomtoken=<room_token>&id=<user_id>&token=<token>&state=<state>', 
                   view_func= routes.get_purchase_room_admin)
  app.add_url_rule('/lobby/admin/<id>&type=inventory&roomtoken=<room_token>&id=<user_id>&token=<token>&state=<state>', 
