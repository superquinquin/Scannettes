...
# from cannettes_v2.packages.lobby import Lobby
# from cannettes_v2.packages.odoo import Odoo
...
#         context["url"] = url_for(
#             "index_admin", id=context["id"], token=context["token"]
#         )
#     print("ask permision", context)
#     emit("permission", context, include_self=True)
